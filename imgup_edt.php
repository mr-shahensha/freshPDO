...
if (isset($_REQUEST['pnm'])) {
    ...
    $page_title = "Advertisement Setup";
}
...
$sls = base64_decode($_REQUEST['sl']);
$fld11['sl'] = $sls;
$op11['sl'] = "=,";

$list11  = new Init_Table();
$list11->set_table("main_img", "sl");
$row1 = $list11->search_custom($fld11, $op11, '', array('sl' => 'ASC'));
foreach ($row1 as $value1) {
}
$user_array = explode(',', $value1['testid']);
                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        <form method="POST" action="imgups.php" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <font color="#ed2618">*</font><label>Image: </label>
                                            <center>
                                                <label for="file"><img style=" cursor: pointer;" title="Select Picture" id="blah" src="<?php echo  $value1['path']; ?>" height="150px" width="400px" alt="your image" /></label>
                                                <div id="size" style="text-align:center; color:#F00;"></div>
                                                <div style="visibility: visible">
                                                    <input  class="btn btn-info" type="file" name="file" id="file" onChange="readURL(this)" accept="image/*" />
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                        <font color="#ed2618">*</font> <label>Sub Divison: </label>
                            ...
                            <input type="hidden" name="sl" value="<?php echo $sls;?>">
                    </div>
                    </form>
                    <!-- /.box body -->
                </div>

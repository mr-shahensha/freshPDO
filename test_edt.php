...
<input type="text" id="ttl" name="ttl" class="form-control" value="<?php echo $row2[0]['ttl'];?>" style="width:100%" placeholder="Enter Test Type" required>
</div>

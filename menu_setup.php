							...
							<div class="row">
								<div class="form-group col-md-3">
									...
									<select id="rmsl" name="rmsl" class="form-control" style="width:100%">
										...
										<?php
										foreach ($row as $valuep) {
											$mnmp = $valuep['mnm'];
											$slp = $valuep['sl'];
										?>
											<option value="<?php echo $slp; ?>"><?php echo $mnmp; ?></option>
										<?php
										}
								...
								<tr>
									...
									<td>
										...
										?>
											...
											<span title="Click to de-activate" class="btn btn-xs btn-danger" onclick="actdct('<?php echo $sl; ?>','main_menu','1','menu_setup.php')">De-activate</span>
										<?php
										}
										?>
										<?php
										...
										?>
											...
											<span class="btn btn-xs btn-info" title="Click to activate" onclick="actdct('<?php echo $sl; ?>','main_menu','0','menu_setup.php')">Activate</span>
										<?php
										}
										?>
									</td>
...
<script>
	  function actdct(sl,tbl,val,pg){
			if(confirm('Are You Sure ?')){
				$('#show').load('actv_deact.php?sl='+sl+'&tbl='+tbl+'&val='+val+'&pg='+pg).fadeIn('fast');
			}

...
class ONS_PDO
{
    ...
    {
        $dsn = 'mysql:dbname=fresh_pdo;host=localhost';
        try {
...
$link = "http://upkarassist.org/upkar/";


date_default_timezone_set('Asia/Kolkata');
$keyId = 'rzp_test_7k3huEOgDnNXBn';
$keySecret = 'J5TDhE0cS3u7UFXVzEk7fbL0';


$mcd = "UPKRA";
$username = "bhabesh.jha_4082";
$authIV = "yyA1dTZvq1Pj2adS";
$authKey = 'EINjZ3nAo0qRtloh';
$spDomain = "https://refundapi.sabpaisa.in/SabPaisaRefundApi/refund";
...
class Car{
	...
	protected function show(){
		echo " and my color is ".$this->color." and price is ".$this->price;		
	}
}

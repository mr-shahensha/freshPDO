...
<tr>
<th>Name</th><td><font color="#000000"><?php echo $fnm.' '.$lnm; ?></font></td></tr>
<tr>
...
<div class="modal fade" id="myModal" role="dialog">
	...
	<div class="col-md-8">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="box-body">
				...
				<form method="POST" action="buildings.php" enctype="multipart/form-data">
	  ...
	  <input  id="oldpass" type="password" value="" name="oldpass"  required class="form-control brd">
			</div>
		</div>
		...
		<div class="col-md-12">
			<div class="form-group">
				<label>New Password : </label>
					  <input  id="password" type="password" value="" name="password"  required class="form-control brd">
			</div>
		</div>
		...
		<div class="col-md-12">
			<div class="form-group">
				...
				<input Confirm Password id="password2" type="password" value="" name="password2" required class="form-control brd">
			</div>
		</div>

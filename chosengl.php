...
$nm = $Members->User_Details->name;
?>



<input type="hidden" id="nm" value="<?php echo $nm; ?>">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            ?>
                                            <select name="upno" id="upno" class="form-control" size="1" tabindex="2">
                                                ...
                                                ?>
                                                    ...
                                                    <option value="<?php echo $value['sl']; ?>"><?php echo $value['ttl']; ?></option>
                                                <?php
                                                }
                                                ?>
